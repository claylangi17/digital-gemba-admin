        ...
        <div class="grid grid-cols-3 p-0 dots-style-circle dots-positioned gap-4 items-center" style="width: 75%">
            ...
            <div>
                <div class="user-grid-card">
                    <div style="border-width: 5px" class="py-8 relative bg-white flex items-center justify-center border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden p-4">
            ...
            <div>
                <div class="user-grid-card">
                    <div style="border-width: 5px; border-color: #FFD700" class="py-16 relative bg-white flex items-center justify-center border rounded-2xl overflow-hidden p-4">
            ...
            <div>
                <div class="user-grid-card">
                    <div style="border-width: 5px; border-color: #CD7F32" class="py-8 relative bg-white flex items-center justify-center border rounded-2xl overflow-hidden p-4">
    ...
    <section class="mt-8">
        ...
        <div class="flex items-center justify-center">
            <div class="grid grid-cols-2 p-0 dots-style-circle dots-positioned gap-4 items-center" style="width: 75%">
                ...
                <div>
                    <div class="user-grid-card">
                        <div style="border-width: 5px" class="relative bg-white border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden p-4">
                ...
                <div>
                    <div class="user-grid-card">
                        <div style="border-width: 5px" class="relative bg-white border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden p-4">
                            ...
                            <p class="bg-primary-100 dark:bg-primary-600/25 text-primary-600 dark:text-primary-400 px-6 py-1.5 rounded-md font-medium text-base mb-2">
                                Memberikan Akar Masalah = +1 hingga +10
                            </p>
                        </div>
                    </div>
                </div>
