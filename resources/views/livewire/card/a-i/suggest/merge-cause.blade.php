    ...
    <div class="relative p-4 max-h-full" style="width: 80%">
        <div class="relative bg-white rounded-lg shadow dark:bg-dark-2">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white"> Tanya AI Untuk Menggabungkan Akar Masalah </h3>
            ...
            <div class="mb-3 flex items-center gap-6 justify-between p-6">
                <label for="possible_category" class="inline font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Gabungkan Akar Masalah</label>
                <div class="flex items-center gap-6 w-1/2 justify-end">
    
                    <button wire:click="get_suggestion()" class="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2">
            ...
            <div class="mb-3 p-6" wire:loading.remove wire:target="get_suggestion" id="rootcause-table">
                <div class="table-responsive">
                    <table class="table border-0 mb-0" style="width: 100%; table-layout: fixed; overflow-wrap: break-word;">
                        <thead>
                            <tr>
                                <th class="">Saran Gabungan Masalah</th>
                                <th class="">Kategori</th>
                                <th class="">Dibuat Dari</th>
                                <th class="">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($suggestions)
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <button wire:click="save_suggestion({{ json_encode(["merged" => $item["merged"], "category" => $item["category"], "originals" => $item["originals"] ]) }})" class="btn bg-success-600 text-sm text-white btn-sm px-3 py-3 rounded-lg flex items-center gap-2 mx-auto">
                                            <iconify-icon icon="mingcute:ai-line" class="icon text-xl line-height-1"></iconify-icon>
                                            Simpan Saran Gabungan
                                        </button>
                                    </td>
                                </tr>
                                @endforeach
